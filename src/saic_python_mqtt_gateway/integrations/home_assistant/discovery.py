...
from saic_python_mqtt_gateway.publisher.mqtt_publisher import MqttPublisher
...
class HomeAssistantDiscovery:
    def __init__(
        ...
        self.__vehicle_prefix = vehicle_prefix
    ...
    def __get_device_node(self) -> dict[str, Any]:
        vin = self.vin
        brand_name = self.__vin_info.brand
        model_name = self.__vin_info.model
        model_year = self.__vin_info.model_year
        color_name = self.__vin_info.color
        series = self.__vin_info.series
    ...
    def __get_vehicle_topic(self, sub_topic: str) -> str:
        publisher = self.__publisher
        topic = f"{self.__vehicle_prefix}/{sub_topic}"
        return publisher.get_topic(topic, no_prefix=False)
    ...
    def __unpublish_ha_discovery_message(
        ...
        self.__publisher.publish_str(ha_topic, "", no_prefix=True)
