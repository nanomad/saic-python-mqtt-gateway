...
from saic_python_mqtt_gateway.utils import datetime_to_str, value_in_range
...
if TYPE_CHECKING:
    ...
    from saic_python_mqtt_gateway.model.vehicle_info import VehicleInfo
...
class VehicleState:
    ...
    def handle_vehicle_status(
        self, processing_result: VehicleStatusRespProcessingResult
    ) -> None:
    ...
    def handle_charge_status(self, result: ChrgMgmtDataRespProcessingResult) -> None:
