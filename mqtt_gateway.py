...
def get_latest_message(vehicle_start_messages):
...
class MessageHandler:
    ...
    async def __polling(self):
        try:
            ...
            latest_vehicle_start_message = get_latest_message(vehicle_start_messages)

            new_messages = [m for m in all_messages if m.read_status != 'read']
            latest_message = get_latest_message(new_messages)
